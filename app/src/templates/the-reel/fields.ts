...
export const fields: FieldDescriptor[] = [
  ...
  { kind: 'section', label: 'Background video' },
  {
    ...
    aspectRatio: 9 / 16,
    acceptVideo: true,
    hint: 'Paste a hosted video URL (mp4 / webm / mov). The video plays full-bleed, muted, looped behind every scene. A still image works too if you want a frozen backdrop.',
  },
  {
    kind: 'slider',
    path: 'videoDim',
